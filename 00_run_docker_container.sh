...
host_dir_synthetic_training_config=$HOME/Repos/mmdetection3d/configs/synthetic_training_config
...
host_dir_training_data=$HOME/Synthetic_Datasets/mvxnet-datasets/baseline-datasets/baseline_5_percent
